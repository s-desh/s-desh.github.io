---
title: "SDFGen: A library to generate Signed Distance Fields"
# author: "Francesco"
# authorAvatarPath: "/avatar.jpeg"
date: "2024-11-08"
summary: "Robotics intern @ Mainblades (3 months)"
...
image: "/images/747400_sdf.png"
---
**Overview**

Mainblades does aircraft inspections autonomously with drones. During my internship, I built a library (based on [Voxfield](https://github.com/VIS4ROB-lab/voxfield)) to represent the obstacle map with SDFs (Signed Distance Fields), this enables using gradient based path planning algorithms, generating smoother trajectories.
